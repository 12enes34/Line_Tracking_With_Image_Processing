...
# Kamerayı aç
camera = cv2.VideoCapture(0)  # Varsayılan kamera cihazını (genellikle bilgisayarın dahili kamerası) açar
...
while True:
    ...
    Blackline = cv2.inRange(frame, (0, 0, 0), (135,135,136))  # Görüntüde siyah renk aralığındaki pikselleri bulurorjınal (75,75,75)
